...
public class ParticleArrays 
{
	...
	public static int AddParticles(LinkedList<Particle> parts) throws Exception
	{
		synchronized (ParticleArrays.ParticleCountChangeLock)
		{
			synchronized (ParticleArrays.VisualLock)
			{
				...
				{
					ParticleArrays.AddParticle(part.X,part.Y,part.velX,part.velY,part.Mass,part.Size,part.Elasticity,part.Repusivity,part.Bounces,part.Red,part.Green,part.Blue);
				}
				UpdateParticleField();
	...
	private static void AddParticle(float X, float Y, float velX, float velY, float Mass, float Size, float Elasticity, 
	...
	private static void UpdateParticleField() throws Exception
	{
		...
		ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(2,ArgType.Input,ParticleArrays.velX));
		ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(3,ArgType.Input,ParticleArrays.velY));
		//ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(5,ArgType.Input,ParticleArrays.velZ));
		ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(4,ArgType.Output,ParticleArrays.accX));
		ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(5,ArgType.Output,ParticleArrays.accY));
		//ParticleField.kernel.kernelArgs.add(new OpenCLKernelArg(8,ArgType.Output,ParticleArrays.accZ));
